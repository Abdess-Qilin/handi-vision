...
const SupprimerCandidat = () => {
  ...
  return (
                ...
                <h2 className="h2 btn-danger m-1 p-2">Supprimer ce Compte</h2>
                <div className="column btn-danger m-1 p-2">
                   <span className="btn btn-primary m-1"> Êtes-vous sûr de vouloir supprimer ce Compte ? </span>
...
export default SupprimerCandidat;
