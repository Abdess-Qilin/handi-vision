...
const SupprimerElementRecruteur = ({ type }) => {
        ...
        <div className="col-md-6 ibox-content column con-b">
            ...
            <div className="col-12 text-center m-t con-a">
                ...
                <div className="column btn-danger m-1 p-2">
                    <span className="btn btn-primary m-1"> Êtes-vous sûr de vouloir supprimer cette {type} ? </span>
...
export default SupprimerElementRecruteur;
